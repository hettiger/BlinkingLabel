...
This CocoaPod provides the ability to use a UILabel that may be started and stopped blinking.
  ...
  s.homepage         = 'https://github.com/hettiger/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Martin Hettiger' => 'martin@hettiger.com' }
  s.source           = { :git => 'https://github.com/hettiger/BlinkingLabel.git', :tag => s.version.to_s }
